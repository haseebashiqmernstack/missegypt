                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="home-img padd-15">
                            <img src="./images/safinaz.jpg" alt="">
                        </div>
                    </div>
                </div>
            </section>
                        ...
                        <div class="about-content padd-15">
                            <div class="row">
                                <div class="about-text padd-15">
                                    <h3>I' m Safinaz Ahmad Mubarak <span>Representative African Women</span></h3>
                                    <p>I working in GIS field with extensive experience for over 5 years.
                                        ...
                                        <div class="timeline-box padd-15">
                                            <div class="timeline shadow-dark">
                                               ...
                                               <div class="timeline-item">
                                                  <div class="circle-dot"></div>
                                                  <h3 class="timeline-date">
                                                      <i class="fa fa-calendar"></i> May 2021-Present 10 mos
                                                  </h3>
                                                  <h4 class="timeline-title">
                                                      Zonal Representative
                                                  </h4>
                                                  <p class="timeline-text">
                                                     African Women in GIS (Egypt)
                                                  </p>
                                               </div>
                                               <!-- timeline item -->
                                               <div class="timeline-item">
                                                  <div class="circle-dot"></div>
                                                  <h3 class="timeline-date">
                                                      <i class="fa fa-calendar"></i> Dec 2020-Jan 2022 1 yr 2 mos
                                                  </h3>
                                                  <h4 class="timeline-title">
                                               ...
                                               <div class="timeline-item">
                                                <div class="circle-dot"></div>
                                                <h3 class="timeline-date">
                                                    <i class="fa fa-calendar"></i> Apr 2020-Apr 2021 1 yr 1 mos
                                                </h3>
                                                <h4 class="timeline-title">
                                                    Technical Support Specialist
                                                </h4>
                                                <p class="timeline-text">
                                                    EDGE Pro for Information System
                                                </p>
                                             </div>
                                             <!-- timeline item -->
                                             <div class="timeline-item">
                                                <div class="circle-dot"></div>
                                                <h3 class="timeline-date">
                                                    <i class="fa fa-calendar"></i> Feb 2019-Apr 2020 1 yr 3 mos
                                                </h3>
                                                <h4 class="timeline-title">
                                                    Technical Office
                                                </h4>
                                             ...
                                             <div class="timeline-item">
                                                <div class="circle-dot"></div>
                                                <h3 class="timeline-date">
                                                    <i class="fa fa-calendar"></i> Mar 2019-Jan 2020 11 mos
                                                </h3>
                                                <h4 class="timeline-title">
                                                    Technical Office
                                                </h4>
                    ...
                    <div class="row">
                        ...
                        <div class="service-item">
                            <div class="service-item-inner">
                                ...
                                <h4>Web Design</h4>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis architecto quos, odio deleniti explicabo optio a voluptate nihil nobis ex?</p>
                            </div>
                        </div>
                        <!-- service item end -->
                        <!-- serviec item start -->
